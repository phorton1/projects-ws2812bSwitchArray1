...
// this is the font I ripped from adafruit's gfx library
unsigned char font5x8[256][8]={
{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},    // 0x00
{0x0E,0x1F,0x15,0x1F,0x1B,0x11,0x0E,0x00},    // 0x01
{0x0E,0x1F,0x15,0x1F,0x11,0x1B,0x0E,0x00},    // 0x02
{0x00,0x0A,0x1F,0x1F,0x1F,0x0E,0x04,0x00},    // 0x03
{0x00,0x04,0x0E,0x1F,0x1F,0x0E,0x04,0x00},    // 0x04
{0x0E,0x0A,0x1F,0x15,0x1F,0x04,0x0E,0x00},    // 0x05
{0x04,0x0E,0x1F,0x1F,0x1F,0x04,0x0E,0x00},    // 0x06
{0x00,0x00,0x04,0x0E,0x0E,0x04,0x00,0x00},    // 0x07
{0x1F,0x1F,0x1B,0x11,0x11,0x1B,0x1F,0x1F},    // 0x08
{0x00,0x00,0x04,0x0A,0x0A,0x04,0x00,0x00},    // 0x09
{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},    // 0x0A
{0x00,0x1C,0x18,0x16,0x05,0x05,0x02,0x00},    // 0x0B
{0x0E,0x11,0x11,0x0E,0x04,0x1F,0x04,0x00},    // 0x0C
{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},    // 0x0D
{0x1E,0x12,0x1E,0x12,0x12,0x1A,0x03,0x00},    // 0x0E
{0x04,0x15,0x0E,0x1B,0x1B,0x0E,0x15,0x04},    // 0x0F
{0x01,0x03,0x0F,0x1F,0x0F,0x03,0x01,0x00},    // 0x10
{0x10,0x18,0x1E,0x1F,0x1E,0x18,0x10,0x00},    // 0x11
{0x04,0x0E,0x15,0x04,0x15,0x0E,0x04,0x00},    // 0x12
{0x1B,0x1B,0x1B,0x1B,0x1B,0x00,0x1B,0x00},    // 0x13
{0x1E,0x15,0x15,0x16,0x14,0x14,0x14,0x00},    // 0x14
{0x0C,0x12,0x0A,0x14,0x08,0x12,0x12,0x0C},    // 0x15
{0x00,0x00,0x00,0x00,0x00,0x1F,0x1F,0x00},    // 0x16
{0x04,0x0E,0x15,0x04,0x15,0x0E,0x04,0x1F},    // 0x17
{0x00,0x04,0x0E,0x15,0x04,0x04,0x04,0x00},    // 0x18
{0x00,0x04,0x04,0x04,0x15,0x0E,0x04,0x00},    // 0x19
{0x00,0x04,0x08,0x1F,0x08,0x04,0x00,0x00},    // 0x1A
{0x00,0x04,0x02,0x1F,0x02,0x04,0x00,0x00},    // 0x1B
{0x00,0x01,0x01,0x01,0x1F,0x00,0x00,0x00},    // 0x1C
{0x00,0x0A,0x1F,0x1F,0x0A,0x00,0x00,0x00},    // 0x1D
{0x00,0x04,0x04,0x0E,0x1F,0x1F,0x00,0x00},    // 0x1E
{0x00,0x1F,0x1F,0x0E,0x04,0x04,0x00,0x00},    // 0x1F
...
{0x04,0x1E,0x05,0x0E,0x14,0x0F,0x04,0x00},    // 0x24
{0x03,0x13,0x08,0x04,0x02,0x19,0x18,0x00},    // 0x25
{0x02,0x05,0x05,0x02,0x15,0x09,0x16,0x00},    // 0x26
{0x0C,0x0C,0x04,0x02,0x00,0x00,0x00,0x00},    // 0x27
{0x08,0x04,0x02,0x02,0x02,0x04,0x08,0x00},    // 0x28
{0x02,0x04,0x08,0x08,0x08,0x04,0x02,0x00},    // 0x29
{0x04,0x15,0x0E,0x1F,0x0E,0x15,0x04,0x00},    // 0x2A
{0x00,0x04,0x04,0x1F,0x04,0x04,0x00,0x00},    // 0x2B
{0x00,0x00,0x00,0x00,0x0C,0x0C,0x04,0x02},    // 0x2C
...
{0x04,0x06,0x04,0x04,0x04,0x04,0x0E,0x00},    // 0x31
{0x0E,0x11,0x10,0x0E,0x01,0x01,0x1F,0x00},    // 0x32
{0x1F,0x10,0x08,0x0C,0x10,0x11,0x0E,0x00},    // 0x33
{0x08,0x0C,0x0A,0x09,0x1F,0x08,0x08,0x00},    // 0x34
{0x1F,0x01,0x0F,0x10,0x10,0x11,0x0E,0x00},    // 0x35
{0x1C,0x02,0x01,0x0F,0x11,0x11,0x0E,0x00},    // 0x36
{0x1F,0x10,0x10,0x08,0x04,0x02,0x01,0x00},    // 0x37
{0x0E,0x11,0x11,0x0E,0x11,0x11,0x0E,0x00},    // 0x38
{0x0E,0x11,0x11,0x1E,0x10,0x08,0x07,0x00},    // 0x39
{0x00,0x00,0x04,0x00,0x04,0x00,0x00,0x00},    // 0x3A
{0x00,0x00,0x04,0x00,0x04,0x04,0x02,0x00},    // 0x3B
{0x10,0x08,0x04,0x02,0x04,0x08,0x10,0x00},    // 0x3C
{0x00,0x00,0x1F,0x00,0x1F,0x00,0x00,0x00},    // 0x3D
{0x02,0x04,0x08,0x10,0x08,0x04,0x02,0x00},    // 0x3E
{0x0E,0x11,0x10,0x0C,0x04,0x00,0x04,0x00},    // 0x3F
{0x0E,0x11,0x15,0x1D,0x0D,0x01,0x1E,0x00},    // 0x40
{0x04,0x0A,0x11,0x11,0x1F,0x11,0x11,0x00},    // 0x41
{0x0F,0x11,0x11,0x0F,0x11,0x11,0x0F,0x00},    // 0x42
{0x0E,0x11,0x01,0x01,0x01,0x11,0x0E,0x00},    // 0x43
{0x0F,0x11,0x11,0x11,0x11,0x11,0x0F,0x00},    // 0x44
{0x1F,0x01,0x01,0x0F,0x01,0x01,0x1F,0x00},    // 0x45
{0x1F,0x01,0x01,0x0F,0x01,0x01,0x01,0x00},    // 0x46
{0x1E,0x11,0x01,0x01,0x19,0x11,0x1E,0x00},    // 0x47
{0x11,0x11,0x11,0x1F,0x11,0x11,0x11,0x00},    // 0x48
{0x0E,0x04,0x04,0x04,0x04,0x04,0x0E,0x00},    // 0x49
{0x1C,0x08,0x08,0x08,0x08,0x09,0x06,0x00},    // 0x4A
{0x11,0x09,0x05,0x03,0x05,0x09,0x11,0x00},    // 0x4B
{0x01,0x01,0x01,0x01,0x01,0x01,0x1F,0x00},    // 0x4C
{0x11,0x1B,0x15,0x15,0x15,0x11,0x11,0x00},    // 0x4D
{0x11,0x11,0x13,0x15,0x19,0x11,0x11,0x00},    // 0x4E
{0x0E,0x11,0x11,0x11,0x11,0x11,0x0E,0x00},    // 0x4F
{0x0F,0x11,0x11,0x0F,0x01,0x01,0x01,0x00},    // 0x50
{0x0E,0x11,0x11,0x11,0x15,0x09,0x16,0x00},    // 0x51
{0x0F,0x11,0x11,0x0F,0x05,0x09,0x11,0x00},    // 0x52
{0x0E,0x11,0x01,0x0E,0x10,0x11,0x0E,0x00},    // 0x53
{0x1F,0x15,0x04,0x04,0x04,0x04,0x04,0x00},    // 0x54
{0x11,0x11,0x11,0x11,0x11,0x11,0x0E,0x00},    // 0x55
{0x11,0x11,0x11,0x11,0x11,0x0A,0x04,0x00},    // 0x56
{0x11,0x11,0x11,0x15,0x15,0x15,0x0A,0x00},    // 0x57
{0x11,0x11,0x0A,0x04,0x0A,0x11,0x11,0x00},    // 0x58
{0x11,0x11,0x0A,0x04,0x04,0x04,0x04,0x00},    // 0x59
{0x1F,0x10,0x08,0x0E,0x02,0x01,0x1F,0x00},    // 0x5A
{0x1E,0x02,0x02,0x02,0x02,0x02,0x1E,0x00},    // 0x5B
{0x00,0x01,0x02,0x04,0x08,0x10,0x00,0x00},    // 0x5C
{0x1E,0x10,0x10,0x10,0x10,0x10,0x1E,0x00},    // 0x5D
{0x04,0x0A,0x11,0x00,0x00,0x00,0x00,0x00},    // 0x5E
{0x00,0x00,0x00,0x00,0x00,0x00,0x1F,0x00},    // 0x5F
{0x06,0x06,0x04,0x08,0x00,0x00,0x00,0x00},    // 0x60
{0x00,0x00,0x06,0x08,0x0E,0x09,0x1E,0x00},    // 0x61
{0x01,0x01,0x0D,0x13,0x11,0x13,0x0D,0x00},    // 0x62
{0x00,0x00,0x0E,0x11,0x01,0x11,0x0E,0x00},    // 0x63
{0x10,0x10,0x16,0x19,0x11,0x19,0x16,0x00},    // 0x64
{0x00,0x00,0x0E,0x11,0x1F,0x01,0x0E,0x00},    // 0x65
{0x08,0x14,0x04,0x0E,0x04,0x04,0x04,0x00},    // 0x66
{0x00,0x00,0x0E,0x19,0x19,0x16,0x10,0x0E},    // 0x67
{0x01,0x01,0x0D,0x13,0x11,0x11,0x11,0x00},    // 0x68
{0x04,0x00,0x06,0x04,0x04,0x04,0x0E,0x00},    // 0x69
{0x08,0x00,0x08,0x08,0x08,0x09,0x06,0x00},    // 0x6A
{0x01,0x01,0x09,0x05,0x03,0x05,0x09,0x00},    // 0x6B
{0x06,0x04,0x04,0x04,0x04,0x04,0x0E,0x00},    // 0x6C
{0x00,0x00,0x0B,0x15,0x15,0x15,0x15,0x00},    // 0x6D
{0x00,0x00,0x0D,0x13,0x11,0x11,0x11,0x00},    // 0x6E
{0x00,0x00,0x0E,0x11,0x11,0x11,0x0E,0x00},    // 0x6F
{0x00,0x00,0x0D,0x13,0x13,0x0D,0x01,0x01},    // 0x70
{0x00,0x00,0x16,0x19,0x19,0x16,0x10,0x10},    // 0x71
{0x00,0x00,0x0D,0x13,0x01,0x01,0x01,0x00},    // 0x72
{0x00,0x00,0x1E,0x01,0x0E,0x10,0x0F,0x00},    // 0x73
{0x04,0x04,0x1F,0x04,0x04,0x14,0x08,0x00},    // 0x74
{0x00,0x00,0x11,0x11,0x11,0x19,0x16,0x00},    // 0x75
...
{0x00,0x00,0x11,0x11,0x1E,0x10,0x11,0x0E},    // 0x79
...
{0x02,0x15,0x08,0x00,0x00,0x00,0x00,0x00},    // 0x7E
{0x04,0x0E,0x1B,0x11,0x11,0x1F,0x00,0x00},    // 0x7F
{0x0E,0x11,0x01,0x01,0x11,0x0E,0x08,0x06},    // 0x80
{0x00,0x11,0x00,0x11,0x11,0x19,0x16,0x00},    // 0x81
{0x18,0x00,0x0E,0x11,0x1F,0x01,0x1E,0x00},    // 0x82
{0x1F,0x00,0x06,0x08,0x0E,0x09,0x1E,0x00},    // 0x83
{0x00,0x11,0x06,0x08,0x0E,0x09,0x1E,0x00},    // 0x84
{0x03,0x00,0x06,0x08,0x0E,0x09,0x1E,0x00},    // 0x85
{0x0C,0x00,0x06,0x08,0x0E,0x09,0x1E,0x00},    // 0x86
{0x00,0x1E,0x03,0x03,0x1E,0x08,0x0C,0x00},    // 0x87
{0x1F,0x00,0x0E,0x11,0x1F,0x01,0x1E,0x00},    // 0x88
{0x11,0x00,0x0E,0x11,0x1F,0x01,0x1E,0x00},    // 0x89
{0x03,0x00,0x0E,0x11,0x1F,0x01,0x1E,0x00},    // 0x8A
{0x14,0x00,0x0C,0x08,0x08,0x08,0x1C,0x00},    // 0x8B
{0x0C,0x12,0x0C,0x08,0x08,0x08,0x1C,0x00},    // 0x8C
{0x06,0x00,0x0C,0x08,0x08,0x08,0x1C,0x00},    // 0x8D
{0x15,0x0A,0x11,0x11,0x1F,0x11,0x11,0x00},    // 0x8E
{0x04,0x00,0x04,0x0A,0x11,0x1F,0x11,0x11},    // 0x8F
{0x0C,0x00,0x0F,0x01,0x07,0x01,0x0F,0x00},    // 0x90
{0x00,0x00,0x1E,0x08,0x1E,0x09,0x1E,0x00},    // 0x91
{0x1C,0x0A,0x09,0x1F,0x09,0x09,0x19,0x00},    // 0x92
{0x0E,0x11,0x00,0x0E,0x11,0x11,0x0E,0x00},    // 0x93
{0x00,0x11,0x0E,0x11,0x11,0x11,0x0E,0x00},    // 0x94
{0x00,0x03,0x00,0x0E,0x11,0x11,0x0E,0x00},    // 0x95
{0x0E,0x11,0x00,0x11,0x11,0x19,0x16,0x00},    // 0x96
{0x00,0x03,0x00,0x11,0x11,0x19,0x16,0x00},    // 0x97
{0x12,0x00,0x12,0x12,0x12,0x1C,0x10,0x0E},    // 0x98
{0x11,0x0E,0x11,0x11,0x11,0x11,0x0E,0x00},    // 0x99
{0x11,0x00,0x11,0x11,0x11,0x11,0x0E,0x00},    // 0x9A
{0x04,0x04,0x1F,0x05,0x05,0x1F,0x04,0x04},    // 0x9B
{0x0C,0x1A,0x12,0x07,0x02,0x12,0x1F,0x00},    // 0x9C
{0x1B,0x1B,0x0E,0x1F,0x04,0x1F,0x04,0x04},    // 0x9D
{0x07,0x09,0x09,0x07,0x09,0x1D,0x09,0x09},    // 0x9E
{0x18,0x14,0x04,0x0E,0x04,0x04,0x05,0x03},    // 0x9F
{0x18,0x00,0x06,0x08,0x0E,0x09,0x1E,0x00},    // 0xA0
{0x18,0x00,0x0C,0x08,0x08,0x08,0x1C,0x00},    // 0xA1
{0x00,0x18,0x00,0x0E,0x11,0x11,0x0E,0x00},    // 0xA2
{0x00,0x18,0x00,0x11,0x11,0x19,0x16,0x00},    // 0xA3
{0x00,0x1E,0x00,0x0E,0x12,0x12,0x12,0x00},    // 0xA4
{0x1F,0x00,0x13,0x17,0x1D,0x19,0x11,0x00},    // 0xA5
{0x0E,0x09,0x09,0x1E,0x00,0x1F,0x00,0x00},    // 0xA6
{0x0E,0x11,0x11,0x0E,0x00,0x1F,0x00,0x00},    // 0xA7
{0x04,0x00,0x04,0x06,0x01,0x11,0x0E,0x00},    // 0xA8
{0x00,0x00,0x00,0x1F,0x01,0x01,0x00,0x00},    // 0xA9
{0x00,0x00,0x00,0x1F,0x10,0x10,0x00,0x00},    // 0xAA
{0x01,0x11,0x09,0x1D,0x12,0x19,0x04,0x1C},    // 0xAB
{0x01,0x11,0x09,0x15,0x1A,0x1D,0x10,0x10},    // 0xAC
{0x04,0x04,0x00,0x04,0x04,0x04,0x04,0x00},    // 0xAD
{0x00,0x14,0x0A,0x05,0x0A,0x14,0x00,0x00},    // 0xAE
{0x00,0x05,0x0A,0x14,0x0A,0x05,0x00,0x00},    // 0xAF
{0x0A,0x15,0x0A,0x15,0x0A,0x15,0x0A,0x15},    // 0xB0
{0x1F,0x15,0x1F,0x15,0x1F,0x15,0x1F,0x15},    // 0xB1
{0x08,0x08,0x08,0x08,0x08,0x08,0x08,0x08},    // 0xB2
{0x08,0x08,0x08,0x08,0x0F,0x08,0x08,0x08},    // 0xB3
{0x08,0x08,0x0F,0x08,0x0F,0x08,0x08,0x08},    // 0xB4
{0x14,0x14,0x14,0x14,0x17,0x14,0x14,0x14},    // 0xB5
{0x00,0x00,0x00,0x00,0x1F,0x14,0x14,0x14},    // 0xB6
{0x00,0x00,0x0F,0x08,0x0F,0x08,0x08,0x08},    // 0xB7
{0x14,0x14,0x17,0x10,0x17,0x14,0x14,0x14},    // 0xB8
{0x14,0x14,0x14,0x14,0x14,0x14,0x14,0x14},    // 0xB9
{0x00,0x00,0x1F,0x10,0x17,0x14,0x14,0x14},    // 0xBA
{0x14,0x14,0x17,0x10,0x1F,0x00,0x00,0x00},    // 0xBB
{0x14,0x14,0x14,0x14,0x1F,0x00,0x00,0x00},    // 0xBC
{0x08,0x08,0x0F,0x08,0x0F,0x00,0x00,0x00},    // 0xBD
{0x00,0x00,0x00,0x00,0x0F,0x08,0x08,0x08},    // 0xBE
{0x08,0x08,0x08,0x08,0x18,0x00,0x00,0x00},    // 0xBF
{0x08,0x08,0x08,0x08,0x1F,0x00,0x00,0x00},    // 0xC0
{0x00,0x00,0x00,0x00,0x1F,0x08,0x08,0x08},    // 0xC1
{0x08,0x08,0x08,0x08,0x18,0x08,0x08,0x08},    // 0xC2
{0x00,0x00,0x00,0x00,0x1F,0x00,0x00,0x00},    // 0xC3
{0x08,0x08,0x08,0x08,0x1F,0x08,0x08,0x08},    // 0xC4
{0x08,0x08,0x18,0x08,0x18,0x08,0x08,0x08},    // 0xC5
{0x14,0x14,0x14,0x14,0x14,0x14,0x14,0x14},    // 0xC6
{0x14,0x14,0x14,0x04,0x1C,0x00,0x00,0x00},    // 0xC7
{0x00,0x00,0x1C,0x04,0x14,0x14,0x14,0x14},    // 0xC8
{0x14,0x14,0x17,0x00,0x1F,0x00,0x00,0x00},    // 0xC9
{0x00,0x00,0x1F,0x00,0x17,0x14,0x14,0x14},    // 0xCA
{0x14,0x14,0x14,0x04,0x14,0x14,0x14,0x14},    // 0xCB
{0x00,0x00,0x1F,0x00,0x1F,0x00,0x00,0x00},    // 0xCC
{0x14,0x14,0x17,0x00,0x17,0x14,0x14,0x14},    // 0xCD
{0x08,0x08,0x1F,0x00,0x1F,0x00,0x00,0x00},    // 0xCE
{0x14,0x14,0x14,0x14,0x1F,0x00,0x00,0x00},    // 0xCF
{0x00,0x00,0x1F,0x00,0x1F,0x08,0x08,0x08},    // 0xD0
{0x00,0x00,0x00,0x00,0x1F,0x14,0x14,0x14},    // 0xD1
{0x14,0x14,0x14,0x14,0x1C,0x00,0x00,0x00},    // 0xD2
{0x08,0x08,0x18,0x08,0x18,0x00,0x00,0x00},    // 0xD3
{0x00,0x00,0x18,0x08,0x18,0x08,0x08,0x08},    // 0xD4
{0x00,0x00,0x00,0x00,0x1C,0x14,0x14,0x14},    // 0xD5
{0x14,0x14,0x14,0x14,0x1F,0x14,0x14,0x14},    // 0xD6
{0x08,0x08,0x1F,0x08,0x1F,0x08,0x08,0x08},    // 0xD7
{0x08,0x08,0x08,0x08,0x0F,0x00,0x00,0x00},    // 0xD8
{0x00,0x00,0x00,0x00,0x18,0x08,0x08,0x08},    // 0xD9
{0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F},    // 0xDA
{0x00,0x00,0x00,0x00,0x1F,0x1F,0x1F,0x1F},    // 0xDB
{0x07,0x07,0x07,0x07,0x07,0x07,0x07,0x07},    // 0xDC
{0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18},    // 0xDD
{0x1F,0x1F,0x1F,0x1F,0x00,0x00,0x00,0x00},    // 0xDE
{0x00,0x00,0x16,0x09,0x09,0x09,0x16,0x00},    // 0xDF
{0x00,0x0E,0x11,0x0F,0x11,0x11,0x0F,0x01},    // 0xE0
{0x00,0x1F,0x19,0x01,0x01,0x01,0x01,0x00},    // 0xE1
{0x00,0x1F,0x0A,0x0A,0x0A,0x0A,0x0A,0x00},    // 0xE2
{0x1F,0x11,0x02,0x04,0x02,0x11,0x1F,0x00},    // 0xE3
{0x00,0x00,0x1E,0x09,0x09,0x09,0x06,0x00},    // 0xE4
{0x00,0x0A,0x0A,0x0A,0x0A,0x16,0x03,0x00},    // 0xE5
{0x00,0x1F,0x05,0x04,0x04,0x04,0x04,0x00},    // 0xE6
{0x1F,0x04,0x0E,0x11,0x11,0x0E,0x04,0x1F},    // 0xE7
{0x04,0x0A,0x11,0x1F,0x11,0x0A,0x04,0x00},    // 0xE8
{0x04,0x0A,0x11,0x11,0x0A,0x0A,0x1B,0x00},    // 0xE9
{0x0C,0x02,0x0C,0x0E,0x11,0x11,0x0E,0x00},    // 0xEA
{0x00,0x00,0x00,0x0E,0x15,0x15,0x0E,0x00},    // 0xEB
{0x10,0x0E,0x19,0x15,0x15,0x13,0x0E,0x01},    // 0xEC
{0x0E,0x01,0x01,0x0F,0x01,0x01,0x0E,0x00},    // 0xED
{0x0E,0x11,0x11,0x11,0x11,0x11,0x11,0x00},    // 0xEE
{0x00,0x1F,0x00,0x1F,0x00,0x1F,0x00,0x00},    // 0xEF
{0x04,0x04,0x1F,0x04,0x04,0x00,0x1F,0x00},    // 0xF0
{0x02,0x04,0x08,0x04,0x02,0x00,0x1F,0x00},    // 0xF1
{0x08,0x04,0x02,0x04,0x08,0x00,0x1F,0x00},    // 0xF2
{0x1C,0x14,0x04,0x04,0x04,0x04,0x04,0x04},    // 0xF3
{0x04,0x04,0x04,0x04,0x04,0x05,0x05,0x07},    // 0xF4
{0x0C,0x0C,0x00,0x1F,0x00,0x0C,0x0C,0x00},    // 0xF5
{0x00,0x17,0x1D,0x00,0x17,0x1D,0x00,0x00},    // 0xF6
{0x0E,0x1B,0x1B,0x0E,0x00,0x00,0x00,0x00},    // 0xF7
{0x00,0x00,0x00,0x0C,0x0C,0x00,0x00,0x00},    // 0xF8
{0x00,0x00,0x00,0x00,0x0C,0x00,0x00,0x00},    // 0xF9
{0x1C,0x04,0x04,0x04,0x05,0x05,0x06,0x04},    // 0xFA
{0x0E,0x12,0x12,0x12,0x12,0x00,0x00,0x00},    // 0xFB
{0x0E,0x18,0x0C,0x06,0x1E,0x00,0x00,0x00},    // 0xFC
{0x00,0x00,0x1E,0x1E,0x1E,0x1E,0x00,0x00},    // 0xFD
{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},    // 0xFE    
{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}    // 0xFF
};


// this is actually a bad looking 5x5 font
// with descenders and other things that fill
// out to 5x8 that I got from ugui. I hand
// modified it for the calculator

unsigned char font5x5[256][8]={
{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},   // 0x00
...
{0x00,0x0A,0x04,0x0A,0x00,0x00,0x00,0x00},   // 0x2A      ASTERISK = raised x MULTIPLY sign
{0x00,0x04,0x0E,0x04,0x00,0x00,0x00,0x00},   // 0x2B      PLUS SIGN
{0x00,0x00,0x00,0x00,0x00,0x04,0x04,0x02},   // 0x2C
{0x00,0x00,0x0E,0x00,0x00,0x00,0x00,0x00},   // 0x2D      DASH
{0x00,0x00,0x00,0x00,0x00,0x04,0x00,0x00},   // 0x2E
{0x08,0x08,0x04,0x04,0x02,0x02,0x00,0x00},   // 0x2F      SLASH = divide sign
{0x0C,0x12,0x12,0x12,0x12,0x0C,0x00,0x00},   // 0x30
{0x04,0x04,0x04,0x04,0x04,0x0E,0x00,0x00},   // 0x31
...
{0x00,0x0F,0x00,0x0F,0x00,0x00,0x00,0x00},   // 0x3D    EQUALS
